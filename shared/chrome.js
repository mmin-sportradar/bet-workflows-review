...
(function () {
  ...
  function loadAssistant(host) {
    ...
    styles.href = `${root}shared/assistant.css?v=ffea976122`;
    ...
    feedback.src = `${root}shared/feedback.js?v=ffea976122`;
    ...
    onyx.src = `${root}shared/onyx.js?v=ffea976122`;
    document.head.append(onyx);

    const knowledge = document.createElement("script");
    knowledge.src = `${root}shared/knowledge.js?v=ffea976122`;
    knowledge.addEventListener("load", () => {
      const widget = document.createElement("script");
      widget.src = `${root}shared/assistant.js?v=ffea976122`;
