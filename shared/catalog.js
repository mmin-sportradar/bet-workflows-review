...
const families = [
  ...
  },
  {
    ...
    products: [
      ...
      { name: "US Widgets", description: "Sports Page Solutions Widgets setup and existing-product support.", process: "workflows/us-widgets-setup-flow/", docs: "https://developer.sportradar.com/widgets/docs/getting-started", confluence: "https://sportradar.atlassian.net/wiki/spaces/LSS/pages/139181942/US+SIR+Widgets+Review" },
